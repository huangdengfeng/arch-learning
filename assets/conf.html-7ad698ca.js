import{_ as i,p as e,q as n,a1 as s}from"./framework-5866ffd3.js";const l={},d=s(`<h1 id="nginx-常用配置" tabindex="-1"><a class="header-anchor" href="#nginx-常用配置" aria-hidden="true">#</a> nginx 常用配置</h1><h2 id="include-多个配置" tabindex="-1"><a class="header-anchor" href="#include-多个配置" aria-hidden="true">#</a> include 多个配置</h2><p>适用于一套nginx管理多个站点。 修改<code>conf/nginx.conf</code>，在<code>conf</code>目录新建文件夹<code>extra</code>。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>http {
   ...
   include extra/*.conf; 
   server {
        listen       80;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21),a=[d];function r(v,c){return e(),n("div",null,a)}const t=i(l,[["render",r],["__file","conf.html.vue"]]);export{t as default};
