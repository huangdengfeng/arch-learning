import{_ as n,p as s,q as a,a1 as e}from"./framework-5866ffd3.js";const i={},t=e(`<h1 id="linux-常用定位工具" tabindex="-1"><a class="header-anchor" href="#linux-常用定位工具" aria-hidden="true">#</a> linux 常用定位工具</h1><h2 id="网络瓶颈" tabindex="-1"><a class="header-anchor" href="#网络瓶颈" aria-hidden="true">#</a> 网络瓶颈</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看网卡信息，可以看到速率</span>
...
iostat
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),l=[t];function c(d,r){return s(),a("div",null,l)}const m=n(i,[["render",c],["__file","linux.html.vue"]]);export{m as default};
