import{_ as e,p as i,q as n,a1 as d}from"./framework-5866ffd3.js";const a={},s=d(`<h1 id="docker-常用命令" tabindex="-1"><a class="header-anchor" href="#docker-常用命令" aria-hidden="true">#</a> docker 常用命令</h1><h2 id="文档参考" tabindex="-1"><a class="header-anchor" href="#文档参考" aria-hidden="true">#</a> 文档参考</h2><ul><li>中文</li></ul><p>https://www.runoob.com/docker/docker-container-usage.html</p><ul><li>官方</li></ul><p>https://docs.docker.com/engine/reference/run/</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>https://docs.docker.com/engine/install/centos/</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#启动
...
--network host
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>dockerFile 编写文档</p><p>https://docs.docker.com/engine/reference/builder/</p><p>https://www.runoob.com/docker/docker-dockerfile.html</p>`,26),r=[s];function l(c,v){return i(),n("div",null,r)}const m=e(a,[["render",l],["__file","index.html.vue"]]);export{m as default};
