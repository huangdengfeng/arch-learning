import{_ as e,p as i,q as n,a1 as s}from"./framework-5866ffd3.js";const a="/arch-learning/images/tcp.png",r={},d=s('<h1 id="tcp-日常使用" tabindex="-1"><a class="header-anchor" href="#tcp-日常使用" aria-hidden="true">#</a> tcp 日常使用</h1><h2 id="查看全栈队列-backlog-和半连接队列" tabindex="-1"><a class="header-anchor" href="#查看全栈队列-backlog-和半连接队列" aria-hidden="true">#</a> 查看全栈队列(backlog)和半连接队列</h2><p>ss -lnt <img src="'+a+`" alt="全栈队列"></p><p>TCP三次握手时，Linux内核会维护两个队列：</p><ul><li>半连接队列，被称为SYN队列</li><li>全连接队列，被称为 accept队列</li></ul><p>LISTEN 状态下数据：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># -l 显示正在Listener 的socket
# -n 不解析服务名称
# -t 只显示tcp
